...
pub static LAYERS: keyberon::layout::Layers<CustomActions> = &[
    ...
    /* Dvorak */
    &[
        &[k(No),   k(Escape),   k(Kb1),    k(Kb2),   k(Kb3),   k(Kb4),   k(Kb5),   k(Kb6),   k(Kb7),   k(Kb8),   k(Kb9),   k(Kb0),  k(LBracket), k(RBracket), k(BSpace), k(Application)],
        &[k(LGui), k(Tab),      k(Quote),  k(Comma), k(Dot),   k(P),     k(Y),     k(F),     k(G),     k(C),     k(R),     k(L),    k(Slash),    k(Equal),    k(Bslash), k(Delete)],
